...
if (isset($_GET['id'])) {
    ...
    if (isset($_GET['confirm'])) {
        if ($_GET['confirm'] == 'yes') {
            ...
            $stmt = $pdo->prepare('DELETE FROM carte WHERE id = ?');
            $stmt->execute([$_GET['id']]);
...
<div class="content delete" >
    ...
    <div class="yesno" >
        <a href="deleteCarti.php?id=<?=$product['id']?>&confirm=yes" align="center">Yes</a>
        <a href="deleteCarti.php?id=<?=$product['id']?>&confirm=no">No</a> 
    </div>
